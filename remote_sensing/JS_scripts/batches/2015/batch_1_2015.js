...
//##    GLOBAL Variables
//##
var batch_1_2015_regions = ee.FeatureCollection(batch_1_2015_SF);
// print ("Number of fields in the shapefile is", batch_1_2015_regions.size());

var start_date = '2015-01-01';
var end_date = '2015-12-31';
    
// print(batch_1_2015_regions);
...
var batch_1_2015_IC = batch_1_2015_regions.map(extract_sentinel_IC);

// var batch_1_2015_IC_first = ee.ImageCollection(batch_1_2015_IC.first());
// print("1", batch_1_2015_IC.first());

// var an_imggg = batch_1_2015_IC_first.first();
// print("2", an_imggg);

// var batch_1_2015_IC_first_reduced = mosaic_and_reduce_IC_mean(batch_1_2015_IC_first);
// print ("3", batch_1_2015_IC_first_reduced);

var all_fields_TS = batch_1_2015_IC.map(mosaic_and_reduce_IC_mean);

Export.table.toDrive({
  collection: all_fields_TS.flatten(),
  description:'batch_1_2015_TS',
  folder:"batch_1_2015",
  fileFormat: 'CSV'
});
...
// var first_region = batch_1_2015_regions.first();
// var first_NDVI_TS = ui.Chart.image.doySeriesByYear({
//                             imageCollection: batch_1_2015_IC_first, 
//                             bandName: 'NDVI', 
