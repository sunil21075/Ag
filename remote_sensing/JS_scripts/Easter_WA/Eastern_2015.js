...
var wend_date = '2015-12-31';
var cloud_perc = 10;

// Sentinel has come to North America since June 23, 2015
// var end_days = ee.List(["31","30","31","30","31"]);
// var smonth = ee.List([  "08","09","10","11","12"]); 
// var imonth = ee.List.sequence(0, 4);

// var compute = function(month) {
//   var ed = ee.String(end_days.get(month));
//   var m = ee.String(smonth.get(month));
//   var start_date = ee.String('2015-').cat(m).cat('-01');
//   var end_date = ee.String('2015-').cat(m).cat('-').cat(ed);
...
var outfile_name = 'Eastern_WA_2015_' + cloud_perc + "cloud_selectors";
