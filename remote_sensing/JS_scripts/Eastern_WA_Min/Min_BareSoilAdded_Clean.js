...
var outfile_name = 'test_monthly_fc_origin';// + smonth[month];
...
Export.table.toDrive({
  ...
  fileFormat: 'CSV',
   selectors:['ID', "Acres", "BSI", 
             "CovrCrp", "CropGrp", "CropTyp", "DataSrc", 'EVI',
             "ExctAcr", "IntlSrD", "Irrigtn", 
             "LSWI", "LstSrvD", 'NDVI', "NDWI", "Notes", 
             "PSRI", "RtCrpTy", "Shap_Ar", "Shp_Lng", "TRS", 
             "county", "doy", "system.time_start"]
});
