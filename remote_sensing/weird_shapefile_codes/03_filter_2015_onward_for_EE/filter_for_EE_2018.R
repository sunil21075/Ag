...
base_write <- paste0("/Users/hn/Documents/01_research_data/Ag_check_point/", 
                     ...
                     "05_filtered_shapefiles/for_EE/batches/2018/")
...
WSDACrop <- WSDACrop[WSDACrop@data$year ==2018, ]
...
Spokane <- WSDACrop[grepl('Spokane', WSDACrop$county), ] #0 rows
...
Walla_Walla <- WSDACrop[grepl('Walla Walla', WSDACrop$county), ] # 8
