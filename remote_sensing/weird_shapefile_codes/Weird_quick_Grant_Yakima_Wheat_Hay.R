...
data_dir <- paste0("/Users/hn/Documents/01_research_data/", 
                   ...
                   "01_true_shapefiles_separate_years/") # 01_true_shapefiles_separate_years, 02_correct_years_separate
...
Grant_wheat_irrigated <- Grant_wheat_irrigated[!(grepl('Fallow', Grant_wheat_irrigated$CropTyp)), ] # ingnore Wheat Fallow

Grant_wheat_non_irrigated <- Grant_non_irrigated[grepl('Wheat', Grant_non_irrigated$CropTyp), ]
Grant_wheat_non_irrigated <- Grant_wheat_non_irrigated[!(grepl('Fallow', Grant_wheat_non_irrigated$CropTyp)), ]
...
Yakima_wheat_irrigated <- Yakima_wheat_irrigated[!grepl('Fallow', Yakima_wheat_irrigated$CropTyp), ]

Yakima_wheat_non_irrigated <- Yakima_non_irrigated[grepl('Wheat', Yakima_non_irrigated$CropTyp), ]
Yakima_wheat_non_irrigated <- Yakima_wheat_non_irrigated[!grepl('Fallow', Yakima_wheat_non_irrigated$CropTyp), ]
