...
WSDACrop_2012 <- WSDACrop_2012[WSDACrop_2012@data$CropTyp %in% double_crop_potential_plants$Crop_Type, ]
WSDACrop_2013 <- WSDACrop_2013[WSDACrop_2013@data$CropTyp %in% double_crop_potential_plants$Crop_Type, ]
WSDACrop_2014 <- WSDACrop_2014[WSDACrop_2014@data$CropTyp %in% double_crop_potential_plants$Crop_Type, ]
...
writeOGR(obj = WSDACrop_2012, 
         dsn = paste0(write_dir, "/Grant_potentials_2012/"), 
         layer="Grant_2012", 
         driver="ESRI Shapefile")

writeOGR(obj = WSDACrop_2013, 
         dsn = paste0(write_dir, "/Grant_potentials_2013/"), 
         layer="Grant_2013", 
         driver="ESRI Shapefile")

writeOGR(obj = WSDACrop_2014, 
         dsn = paste0(write_dir, "/Grant_potentials_2014/"), 
         layer="Grant_2014", 
         driver="ESRI Shapefile")
