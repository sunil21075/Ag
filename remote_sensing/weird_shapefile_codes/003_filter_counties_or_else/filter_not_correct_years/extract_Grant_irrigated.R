...
writeOGR(obj = WSDACrop_2012, 
         dsn = paste0(write_dir, "/Grant_2012_irrigated/"), 
         layer="Grant_2012_irrigated", 
         driver="ESRI Shapefile")

writeOGR(obj = WSDACrop_2013, 
         dsn = paste0(write_dir, "/Grant_2013_irrigated/"), 
         layer="Grant_2013_irrigated", 
         driver="ESRI Shapefile")

writeOGR(obj = WSDACrop_2014, 
         dsn = paste0(write_dir, "/Grant_2014_irrigated/"), 
         layer="Grant_2014_irrigated", 
         driver="ESRI Shapefile")
