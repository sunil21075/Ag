...
regular_output_dir = "/data/hydro/users/Hossein/remote_sensing/04_RegularFilledGaps_plots_tbls/tables/" + \
                     "/Grant_" + str(SF_year) + "_regular/" + "/savitzky_" + indeks + "/" + \
...
raw_output_dir = "/data/hydro/users/Hossein/remote_sensing/02_Eastern_WA_plots_tbls/tables/" + \
                 "/Grant_" + str(SF_year) + "_raw/" + "/savitzky_" + indeks + "/" + \
                 "/delta" + str(delt) + "_Sav_win" + str(Sav_win_size) + "_Order"  + str(sav_order) + "/"
