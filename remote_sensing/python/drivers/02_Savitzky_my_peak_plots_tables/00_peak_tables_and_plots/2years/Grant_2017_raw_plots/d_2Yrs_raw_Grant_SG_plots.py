...
data_dir = "/data/hydro/users/Hossein/remote_sensing/02_Eastern_WA_EE/2Years/"
...
for a_poly in polygon_list:
    ...
    if (len(os.listdir(plot_path)) < 100):
        ...
        rcp.savitzky_2yrs_panel(crr_fld = curr_field, idx = "EVI", deltA = 0.1, SFYr = SF_year, ax = ax1)
        rcp.savitzky_2yrs_panel(crr_fld = curr_field, idx = "EVI", deltA = 0.2, SFYr = SF_year, ax = ax2)
        rcp.savitzky_2yrs_panel(crr_fld = curr_field, idx = "EVI", deltA = 0.3, SFYr = SF_year, ax = ax3)
        rcp.savitzky_2yrs_panel(crr_fld = curr_field, idx = "EVI", deltA = 0.4, SFYr = SF_year, ax = ax4)
