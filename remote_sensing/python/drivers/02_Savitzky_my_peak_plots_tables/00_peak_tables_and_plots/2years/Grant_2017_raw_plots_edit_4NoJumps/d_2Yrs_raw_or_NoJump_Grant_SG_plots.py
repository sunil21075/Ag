...
data_dir_raw = "/data/hydro/users/Hossein/remote_sensing/02_Eastern_WA_EE_TS/2Years/"
data_dir_noJumps = "/data/hydro/users/Hossein/remote_sensing/02_Eastern_WA_EE_TS/2Years/02_noOutlierNoJumpMerged/"
...
if jumps == "yes":
    output_dir = "/data/hydro/users/Hossein/remote_sensing/02_Eastern_WA_plots_tbls/" + \
                 "2Yrs_plots_raw/" + given_county + "_" + str(SF_year) + "_raw_" + output_Irr + "_" + indeks + "/" 
else:
    output_dir = "/data/hydro/users/Hossein/remote_sensing/02_Eastern_WA_plots_tbls/" + \
                 "2Yrs_plots_noJump/" + given_county + "_" + str(SF_year) + "_noJump_" + output_Irr + "_" + indeks + "/" 
...
for a_poly in polygon_list:
    ...
    if (len(os.listdir(plot_path)) < 500):
