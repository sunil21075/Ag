...
data_dir = "/data/hydro/users/Hossein/remote_sensing/02_Regularized_TS/"
...
f_name = county + "_SF_" + str(SF_year) + "_" + indeks + ".csv"
an_EE_TS = pd.read_csv(data_dir + f_name, low_memory=False)

########################################################################################

output_dir = "/data/hydro/users/Hossein/remote_sensing/03_RegularFilledGaps/"
...
out_name = output_dir + county + "_SF_" + str(SF_year) + "_" + indeks + ".csv"
