...
shinyServer(function(input, output, session) {
  ...
  output$location_group <- renderImage({
    filename <- normalizePath(file.path('./plots', 'location-group.png'))
    # Return a list containing the filename and alt text
    list(src = filename, width = 600, height = 600)}, deleteFile = FALSE)
  
  output$ag_vplot <- renderImage({
       filename <- normalizePath(file.path('./plots/LarvaAdult', 'agenerationVsDoY.png'))
       # Return a list containing the filename and alt text
       list(src = filename, width = 1200, height = 800)}, deleteFile = FALSE)
  
  output$lg_vplot <- renderImage({
        filename <- normalizePath(file.path('./plots/LarvaAdult', 'lgenerationVsDoY.png'))
        # Return a list containing the filename and alt text
        list(src = filename, width = 1200, height = 800)}, deleteFile = FALSE)
  
  output$ag_bplot <- renderImage({
        #filename <- normalizePath(file.path('./plots/LarvaAdult', 'genYear_box_plot.png'))
        filename <- normalizePath(file.path('./plots/LarvaAdult', 'adult_generations.png'))
        # Return a list containing the filename and alt text
        list(src = filename, width = 800, height = 600)}, deleteFile = FALSE)
  
  output$lg_bplot <- renderImage({
        #filename <- normalizePath(file.path('./plots/LarvaAdult', 'lgenYear_box_plot.png'))
        filename <- normalizePath(file.path('./plots/LarvaAdult', 'larva_generations.png'))
        # Return a list containing the filename and alt text
        list(src = filename, width = 800, height = 600)}, deleteFile = FALSE)
  
  output$ag_vplot_rcp45 <- renderImage({
        filename <- normalizePath(file.path('./plots/LarvaAdult', 'agenerationVsDoY_rcp45.png'))
        # Return a list containing the filename and alt text
        list(src = filename, width = 1200, height = 800)}, deleteFile = FALSE)
  
  output$lg_vplot_rcp45 <- renderImage({
        filename <- normalizePath(file.path('./plots/LarvaAdult', 'lgenerationVsDoY_rcp45.png'))
        # Return a list containing the filename and alt text
        list(src = filename, width = 1200, height = 800)}, deleteFile = FALSE)
  
  output$ag_bplot_rcp45 <- renderImage({
        #filename <- normalizePath(file.path('./plots/LarvaAdult', 'agenYear_box_plot_rcp45.png'))
        filename <- normalizePath(file.path('./plots/LarvaAdult', 'adult_generations_rcp45.png'))
        # Return a list containing the filename and alt text
        list(src = filename, width = 800, height = 600)}, deleteFile = FALSE)

  output$lg_bplot_rcp45 <- renderImage({
        #filename <- normalizePath(file.path('./plots/LarvaAdult', 'lgenYear_box_plot_rcp45.png'))
        filename <- normalizePath(file.path('./plots/LarvaAdult', 'larva_generations_rcp45.png'))
        # Return a list containing the filename and alt text
        list(src = filename, width = 800, height = 600)}, deleteFile = FALSE)

  output$gen_pop_plot <- renderImage({
    filename <- normalizePath(file.path('./plots/LarvaAdult', 'gen_pop.png'))
    # Return a list containing the filename and alt text
    list(src = filename, width = 1200, height = 900)}, deleteFile = FALSE)

  output$gen_pop_plot1 <- renderImage({
    filename <- normalizePath(file.path('./plots/LarvaAdult', 'gen_pop1.png'))
    
    # Return a list containing the filename and alt text
    list(src = filename, width = 1200, height = 900)}, deleteFile = FALSE)
  
  output$e_vplot <- renderImage({
    filename <- normalizePath(file.path('./plots/LarvaAdult', 'emergDoY.png'))
    
    # Return a list containing the filename and alt text
    list(src = filename, width = 800, height = 600)
    
  }, deleteFile = FALSE)
  output$e_vplot_rcp45 <- renderImage({
    filename <- normalizePath(file.path('./plots/LarvaAdult', 'emergDoY_rcp45.png'))
  ...
  output$e_bplot <- renderImage({
    filename <- normalizePath(file.path('./plots', 'edoy_year.png'))
  ...
  output$d_vplot <- renderImage({
    filename <- normalizePath(file.path('./plots', 'diapPop.png'))
  ...
  output$d_bplot <- renderImage({
    filename <- normalizePath(file.path('./plots', 'dpop_year.png'))
...
########### 
  output$cumDD_mongrps_magdiff <- renderImage({
    filename <- normalizePath(file.path('./plots/DegreeDays', 'cumDD_month_groups_magdiff.png'))
  ...
  output$cumDD_mons_magdiff <- renderImage({
    filename <- normalizePath(file.path('./plots/DegreeDays', 'cumDD_months_magdiff.png'))
  ...
  output$DD_mongrps_magdiff1 <- renderImage({
    filename <- normalizePath(file.path('./plots/DegreeDays', 'DD_month_groups_magdiff1.png'))
  ...
  output$DD_mongrps <- renderImage({
    filename <- normalizePath(file.path('./plots/DegreeDays', 'DD_month_groups.png'))
  ...
  output$cumDD_mongrps_magdiff_rcp45 <- renderImage({
    filename <- normalizePath(file.path('./plots/DegreeDays', 'cumDD_month_groups_magdiff_rcp45.png'))
  ...
  output$cumDD_mons_magdiff_rcp45 <- renderImage({
    filename <- normalizePath(file.path('./plots/DegreeDays', 'cumDD_months_magdiff_rcp45.png'))
  ...
  output$DD_mongrps_magdiff_rcp45 <- renderImage({
    filename <- normalizePath(file.path('./plots/DegreeDays', 'DD_month_groups_magdiff_rcp45.png'))
  ...
  output$DD_mongrps_rcp45 <- renderImage({
    filename <- normalizePath(file.path('./plots/DegreeDays', 'DD_month_groups_rcp45.png'))
...
###########
  ...
  output$rel_pop_cumdd <- renderImage({
    filename <- normalizePath(file.path('./plots/Diapause', 'rel_pop_cumdd.png'))
  ...
  output$rel_pop_doy <- renderImage({
    filename <- normalizePath(file.path('./plots/Diapause', 'rel_pop_doy.png'))
  ...
  output$abs_pop_cumdd <- renderImage({
    filename <- normalizePath(file.path('./plots/Diapause', 'abs_pop_cumdd.png'))
  ...
  output$rel_pop_cumdd_rcp45 <- renderImage({
  ...
  output$abs_pop_cumdd_rcp45 <- renderImage({
    filename <- normalizePath(file.path('./plots/Diapause', 'abs_pop_cumdd_rcp45.png'))
  ...
  output$abs_pop_doy_rcp45 <- renderImage({
  ...
  output$full_bloom <- renderImage({
    ...
    filename <- normalizePath(file.path('./plots', 'bloom2_rcp85.png'))
  ...
  output$cum_larva_pop <- renderImage({
    filename <- normalizePath(file.path('./plots', 'plot_eggHatch_85.png'))
  ...
  output$full_bloom_rcp45 <- renderImage({
    ...
    filename <- normalizePath(file.path('./plots', 'bloom2_rcp45.png'))
  ...
  output$map_diff_emerg <- renderLeaflet({diffType = 3
                                          col = "Emergence"
