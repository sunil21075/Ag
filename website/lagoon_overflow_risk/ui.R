           ...
           tabPanel(tags$b("Regional Plots"),
                    navlistPanel(
                                 ...
                                 tabPanel("Cascade foothills",
                                          fluidRow(tabBox(tabPanel("Annual", 
                                                                   # tags$div(style="width:950px", includeHTML("HTML_plots/Cascade_foothills_85.html")),
                                                                   tags$blockquote("Below we see annual precipitation ranges."),
                                                                   ...
                                                                   br(),br(),
                                                                   tags$blockquote("and finally 25-year/24-hour design storm intensity"),
                                                                   imageOutput("Cascade_foothills_dsi_rcp85")
                                                                   ),
                                 ...
                                 tabPanel("Northwest Cascades",
                                          fluidRow(tabBox( tabPanel("Annual", 
                                                                   # tags$div(style="width:950px", includeHTML("HTML_plots/Northwest_Cascades_85.html")),
                                                                   tags$blockquote("Below we see annual precipitation ranges."),
                                                                   ...
                                                                   br(),br(),
                                                                   tags$blockquote("and finally 25-year/24-hour design storm intensity"),
                                                                   imageOutput("Northwest_Cascades_dsi_rcp85")
                                                                   ),
                                 ...
                                 tabPanel("Northcentral Cascades",
                                          fluidRow(tabBox( tabPanel("Annual", 
                                                                   # tags$div(style="width:950px", includeHTML("HTML_plots/Northcentral_Cascades_85.html")),
                                                                   tags$blockquote("Below we see annual precipitation ranges."),
                                                                   ...
                                                                   br(),br(),
                                                                   tags$blockquote("and finally 25-year/24-hour design storm intensity"),
                                                                   imageOutput("Northcentral_Cascades_dsi_rcp85")
                                                                   ),
                                 ...
                                 tabPanel("Northeast Cascades",
                                          fluidRow(tabBox( tabPanel("Annual", 
                                                                   # tags$div(style="width:950px", includeHTML("HTML_plots/Northeast_Cascades_85.html")),
                                                                   tags$blockquote("Below we see annual precipitation ranges."),
                                                                   ...
                                                                   br(),br(),
                                                                   tags$blockquote("and finally 25-year/24-hour design storm intensity"),
                                                                   imageOutput("Northeast_Cascades_dsi_rcp85")
                                                                   ),
...
####### Western Coastal 45 start
                                 tabPanel("Western coastal",
                                          fluidRow(tabBox(tabPanel("Annual", 
                                                                   # tags$div(style="width:950px", includeHTML("HTML_plots/Western_Coastal_45.html")),
                                                                   tags$blockquote("Below we see annual precipitation ranges."),
                                                                   ...
                                                                   br(),br(),
                                                                   tags$blockquote("and finally 25-year/24-hour design storm intensity"),
                                                                   imageOutput("Western_coastal_dsi_rcp45")
                                                                   ),
                                 ...
                                 tabPanel("Cascade foothills",
                                          fluidRow(tabBox(tabPanel("Annual", 
                                                                   # tags$div(style="width:950px", includeHTML("HTML_plots/Cascade_foothills_45.html")),
                                                                   tags$blockquote("Below we see annual precipitation ranges."),
                                                                   ...
                                                                   br(),br(),
                                                                   tags$blockquote("and finally 25-year/24-hour design storm intensity"),
                                                                   imageOutput("Cascade_foothills_dsi_rcp45")
                                                                   ),
                                 ...
                                 tabPanel("Northwest Cascades",
                                          fluidRow(tabBox( tabPanel("Annual", 
                                                                   # tags$div(style="width:950px", includeHTML("HTML_plots/Northwest_Cascades_45.html")),
                                                                   tags$blockquote("Below we see annual precipitation ranges."),
                                                                   ...
                                                                   br(),br(),
                                                                   tags$blockquote("and finally 25-year/24-hour design storm intensity"),
                                                                   imageOutput("Northwest_Cascades_dsi_rcp45")
                                                                   ),
                                 ...
                                 tabPanel("Northcentral Cascades",
                                          fluidRow(tabBox( tabPanel("Annual", 
                                                                   # tags$div(style="width:950px", includeHTML("HTML_plots/Northcentral_Cascades_45.html")),
                                                                   tags$blockquote("Below we see annual precipitation ranges."),
                                                                   ...
                                                                   br(),br(),
                                                                   tags$blockquote("and finally 25-year/24-hour design storm intensity"),
                                                                   imageOutput("Northcentral_Cascades_dsi_rcp45")
                                                                   ),
                                 ...
                                 tabPanel("Northeast Cascades",
                                          fluidRow(tabBox( tabPanel("Annual", 
                                                                   # tags$div(style="width:950px", includeHTML("HTML_plots/Northeast_Cascades_45.html")),
                                                                   tags$blockquote("Below we see annual precipitation ranges."),
                                                                   ...
                                                                   br(),br(),
                                                                   tags$blockquote("and finally 25-year/24-hour design storm intensity"),
                                                                   imageOutput("Northeast_Cascades_dsi_rcp45")
                                                                   ),
