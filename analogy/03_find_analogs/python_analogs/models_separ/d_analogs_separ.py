...
main_out_dir = "/data/hydro/users/Hossein/analog/z_python_results/"

us_features_dir = main_in + "usa/ready_features/"
all_data_usa = pd.read_csv(us_features_dir + "all_data_usa.csv") 

local_feat_main = main_in + "local/ready_features/" + model_name +"/"
...
print ("file name is: ")
print (local_feat_main + "feat_" + model_name.replace("_", "-") + "_" + rcp + ".csv")
avg = pd.read_csv(local_feat_main + "feat_" + model_name.replace("_", "-") + "_" + rcp + ".csv") 
all_data_usa.head(2)
avg.head(2)
out_dir = main_out_dir + model_name + "/" + rcp + "/"
