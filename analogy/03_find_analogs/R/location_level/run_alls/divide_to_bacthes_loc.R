...
q_rcp45_w_precip_w_gen3 <- local_locs<- paste0("q_rcp45_w_precip_w_gen3_", q_rcp45_w_precip_w_gen3)
q_rcp45_w_precip_no_gen3 <- local_locs<- paste0("q_rcp45_w_precip_no_gen3_", q_rcp45_w_precip_no_gen3)
q_rcp45_no_precip_w_gen3 <- local_locs<- paste0("q_rcp45_no_precip_w_gen3_", q_rcp45_no_precip_w_gen3)
q_rcp45_no_precip_no_gen3 <- local_locs<- paste0("q_rcp45_no_precip_no_gen3_", q_rcp45_no_precip_no_gen3)


q_rcp85_w_precip_w_gen3 <- local_locs<- paste0("q_rcp85_w_precip_w_gen3_", q_rcp85_w_precip_w_gen3)
q_rcp85_w_precip_no_gen3 <- local_locs<- paste0("q_rcp85_w_precip_no_gen3_", q_rcp85_w_precip_no_gen3)
q_rcp85_no_precip_w_gen3 <- local_locs<- paste0("q_rcp85_no_precip_w_gen3_", q_rcp85_no_precip_w_gen3)
q_rcp85_no_precip_no_gen3 <- local_locs<- paste0("q_rcp85_no_precip_no_gen3_", q_rcp85_no_precip_no_gen3)
