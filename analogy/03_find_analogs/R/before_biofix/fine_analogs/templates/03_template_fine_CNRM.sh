...
#PBS -k o
  ##PBS -j oe
#PBS -e /home/hnoorazar/analog_codes/03_find_analogs/fine/error/precip_type_gen_3_type_CNRM_emission_type_int_file.e
#PBS -o /home/hnoorazar/analog_codes/03_find_analogs/fine/error/precip_type_gen_3_type_CNRM_emission_type_int_file.o
#PBS -m abe
