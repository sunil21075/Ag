...
do
cp 03_template.sh ./rcp45_qsubs/q_rcp45_w_precip_w_gen3_$runname.sh
...
sed -i s/model_type/"$runname"/g ./rcp45_qsubs/q_rcp45_w_precip_w_gen3_$runname.sh
done
...
for runname in bcc-csm1-1-m BNU-ESM CanESM2 CNRM-CM5 GFDL-ESM2G GFDL-ESM2M
do
cp 03_template.sh ./rcp45_qsubs/q_rcp45_no_precip_w_gen3_$runname.sh
...
sed -i s/model_type/"$runname"/g ./rcp45_qsubs/q_rcp45_no_precip_w_gen3_$runname.sh
done
...
for runname in bcc-csm1-1-m BNU-ESM CanESM2 CNRM-CM5 GFDL-ESM2G GFDL-ESM2M
do
cp 03_template.sh ./rcp85_qsubs/q_rcp85_w_precip_w_gen3_$runname.sh
...
sed -i s/model_type/"$runname"/g ./rcp85_qsubs/q_rcp85_w_precip_w_gen3_$runname.sh
done
...
for runname in bcc-csm1-1-m BNU-ESM CanESM2 CNRM-CM5 GFDL-ESM2G GFDL-ESM2M
do
cp 03_template.sh ./rcp85_qsubs/q_rcp85_no_precip_w_gen3_$runname.sh
...
sed -i s/model_type/"$runname"/g ./rcp85_qsubs/q_rcp85_no_precip_w_gen3_$runname.sh
done
