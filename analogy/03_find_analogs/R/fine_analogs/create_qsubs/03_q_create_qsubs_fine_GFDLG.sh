...
sed -i s/model_type/"$LINE"/g ./rcp45_qsubs/GFDLG/q_rcp45_no_precip_w_gen3_$LINE.sh
done
...
# sed -i s/model_type/"$LINE"/g ./rcp45_qsubs/GFDLG/q_rcp45_w_precip_no_gen3_$LINE.sh
# done
...
# sed -i s/model_type/"$LINE"/g ./rcp45_qsubs/GFDLG/q_rcp45_no_precip_no_gen3_$LINE.sh
# done
...
sed -i s/model_type/"$LINE"/g ./rcp85_qsubs/GFDLG/q_rcp85_w_precip_w_gen3_$LINE.sh
done
...
sed -i s/model_type/"$LINE"/g ./rcp85_qsubs/GFDLG/q_rcp85_no_precip_w_gen3_$LINE.sh
done
...
# sed -i s/model_type/"$LINE"/g ./rcp85_qsubs/GFDLG/q_rcp85_w_precip_no_gen3_$LINE.sh
# done
...
# sed -i s/model_type/"$LINE"/g ./rcp85_qsubs/GFDLG/q_rcp85_no_precip_no_gen3_$LINE.sh
# done
