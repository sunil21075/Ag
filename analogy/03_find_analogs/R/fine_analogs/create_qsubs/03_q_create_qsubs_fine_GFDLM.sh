...
sed -i s/int_file/"$LINE"/g ./rcp45_qsubs/GFDLM/q_rcp45_no_precip_w_gen3_$LINE.sh
done
...
# sed -i s/int_file/"$LINE"/g ./rcp45_qsubs/GFDLM/q_rcp45_w_precip_no_gen3_$LINE.sh
# done
...
# sed -i s/int_file/"$LINE"/g ./rcp45_qsubs/GFDLM/q_rcp45_no_precip_no_gen3_$LINE.sh
# done
...
sed -i s/int_file/"$LINE"/g ./rcp85_qsubs/GFDLM/q_rcp85_w_precip_w_gen3_$LINE.sh
done
...
sed -i s/int_file/"$LINE"/g ./rcp85_qsubs/GFDLM/q_rcp85_no_precip_w_gen3_$LINE.sh
done
...
# sed -i s/int_file/"$LINE"/g ./rcp85_qsubs/GFDLM/q_rcp85_w_precip_no_gen3_$LINE.sh
# done
...
# sed -i s/int_file/"$LINE"/g ./rcp85_qsubs/GFDLM/q_rcp85_no_precip_no_gen3_$LINE.sh
# done
