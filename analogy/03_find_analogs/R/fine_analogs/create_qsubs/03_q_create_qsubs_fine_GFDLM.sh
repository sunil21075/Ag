...
cp 03_template_fine_GFDLM.sh ./rcp45_qsubs/GFDLM/q_rcp45_w_precip_w_gen3_$LINE.sh
...
sed -i s/int_file/"$LINE"/g ./rcp45_qsubs/GFDLM/q_rcp45_w_precip_w_gen3_$LINE.sh
done

########### no_precip, w_gen3

cat /home/hnoorazar/analog_codes/parameters/file_names | while read LINE ; do
cp 03_template_fine_GFDLM.sh ./rcp45_qsubs/GFDLM/q_rcp45_no_precip_w_gen3_$LINE.sh
...
sed -i s/model_type/"$LINE"/g ./rcp45_qsubs/GFDLM/q_rcp45_no_precip_w_gen3_$LINE.sh
done

########### w_precip, no_gen3

# cat /home/hnoorazar/analog_codes/parameters/file_names | while read LINE ; do
# cp 03_template_fine_GFDLM.sh ./rcp45_qsubs/GFDLM/q_rcp45_w_precip_no_gen3_$LINE.sh
...
# sed -i s/model_type/"$LINE"/g ./rcp45_qsubs/GFDLM/q_rcp45_w_precip_no_gen3_$LINE.sh
# done

# ########### no_precip, no_gen3

# cat /home/hnoorazar/analog_codes/parameters/file_names | while read LINE ; do
# cp 03_template_fine_GFDLM.sh ./rcp45_qsubs/GFDLM/q_rcp45_no_precip_no_gen3_$LINE.sh
...
# sed -i s/model_type/"$LINE"/g ./rcp45_qsubs/GFDLM/q_rcp45_no_precip_no_gen3_$LINE.sh
# done
...
cat /home/hnoorazar/analog_codes/parameters/file_names | while read LINE ; do
cp 03_template_fine_GFDLM.sh ./rcp85_qsubs/GFDLM/q_rcp85_w_precip_w_gen3_$LINE.sh
...
sed -i s/model_type/"$LINE"/g ./rcp85_qsubs/GFDLM/q_rcp85_w_precip_w_gen3_$LINE.sh
done

########### no_precip, w_gen3

cat /home/hnoorazar/analog_codes/parameters/file_names | while read LINE ; do
cp 03_template_fine_GFDLM.sh ./rcp85_qsubs/GFDLM/q_rcp85_no_precip_w_gen3_$LINE.sh
...
sed -i s/model_type/"$LINE"/g ./rcp85_qsubs/GFDLM/q_rcp85_no_precip_w_gen3_$LINE.sh
done

########### w_precip, no_gen3

# cat /home/hnoorazar/analog_codes/parameters/file_names | while read LINE ; do
# cp 03_template_fine_GFDLM.sh ./rcp85_qsubs/GFDLM/q_rcp85_w_precip_no_gen3_$LINE.sh
...
# sed -i s/model_type/"$LINE"/g ./rcp85_qsubs/GFDLM/q_rcp85_w_precip_no_gen3_$LINE.sh
# done

# ########### no_precip, no_gen3

# cat /home/hnoorazar/analog_codes/parameters/file_names | while read LINE ; do
# cp 03_template_fine_GFDLM.sh ./rcp85_qsubs/GFDLM/q_rcp85_no_precip_no_gen3_$LINE.sh
...
# sed -i s/model_type/"$LINE"/g ./rcp85_qsubs/GFDLM/q_rcp85_no_precip_no_gen3_$LINE.sh
# done
