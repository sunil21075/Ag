...
model_ty = args[2] # Do a full name of models
emission = args[3] # rcp45 rcp85

n_nghs = 47841

main_in <- file.path("/data/hydro/users/Hossein/analog/03_analogs/biofixed/location_level/")
in_dir <- paste0(main_in, precip, "_", emission, "/")
