...
do
cp q_cnty_cnt_precip_45.sh    ./qsubs/cnty_cnt_precip_45_$runname.sh
cp q_cnty_cnt_precip_85.sh    ./qsubs/cnty_cnt_precip_85_$runname.sh
...
sed -i s/all_model_names/$runname/g ./qsubs/cnty_cnt_precip_45_$runname.sh
sed -i s/all_model_names/$runname/g ./qsubs/cnty_cnt_precip_85_$runname.sh
