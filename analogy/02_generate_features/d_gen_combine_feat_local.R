...
for (carbon_type in carbon_types){
  ...
  diapause_dt <- within(diapause_dt, remove("latitude", "longitude"))
  ...
  #
  # The following two lines are now updated in the core.
  # You may get error for this in the future! 
  #
  ...
  # The following line is inserted into the core now.
  ...
  saveRDS(all_data_dt, paste0(main_out_dir, "all_data_", carbon_type, ".rds"))
}
