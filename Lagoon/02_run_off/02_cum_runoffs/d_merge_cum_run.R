...
saveRDS(all_monthly, paste0(out_dir, "/all_monthly_cum_runff_LD.rds"))
rm(all_monthly)
...
saveRDS(all_ann, paste0(out_dir, "/all_ann_cum_runff_LD.rds"))
rm(all_ann)
######################################
#
#       chunky
...
saveRDS(all_chunk, paste0(out_dir, "/all_chunk_cum_runff_LD.rds"))
rm(all_chunk)
######################################
#
#       Water Year
...
saveRDS(all_wtr_yr, paste0(out_dir, "/all_wtr_yr_cum_runff_LD.rds"))
rm(all_wtr_yr)
