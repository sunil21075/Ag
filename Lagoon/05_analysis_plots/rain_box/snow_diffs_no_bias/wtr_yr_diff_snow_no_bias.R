...
ggsave(filename = "no_bias_mag_diff_wtr_yr_snow.png", 
       plot = b, 
...
b <- ann_wtrYr_chunk_cum_box_cluster_x(dt=dt_tb,
                                       ...
                                       subttl=box_subtitle)
b <- b + ggtitle(box_title, subtitle=box_subtitle)
ggsave(filename = "no_bias_perc_diff_wtr_yr_snow.png", 
       plot = b, 
       width = 9.5, height = 5, units = "in", 
       dpi=400, device = "png",
       path = plot_dir)
...
b <- ann_wtrYr_chunk_cum_box_cluster_x(dt=dt_tb_45,
                                       ...
                                       subttl= box_subtitle)
b <- b + ggtitle(box_title, subtitle=box_subtitle)
ggsave(filename = "no_bias_mag_diff_wtr_yr_snow_45.png", 
       plot = b, 
...
ggsave(filename = "no_bias_perc_diff_wtr_yr_snow_45.png", 
       plot = b, 
       width = 4, height = 2.5, units = "in", 
       dpi=500, device = "png",
       path = plot_dir)
...
b <- ann_wtrYr_chunk_cum_box_cluster_x(dt=dt_tb_85,
                                       ...
                                       subttl= box_subtitle)
b <- b + ggtitle(box_title, subtitle=box_subtitle)
ggsave(filename = "no_bias_mag_diff_wtr_yr_snow_85.png", 
       plot = b, 
       width = 4, height = 2.5, units = "in", 
       dpi=500, device = "png",
       path = plot_dir)
...
ggsave(filename = "no_bias_perc_diff_wtr_yr_snow_85.png", 
       plot = b, 
       width = 4, height = 2.5, units = "in", 
       dpi=500, device = "png",
       path = plot_dir)
