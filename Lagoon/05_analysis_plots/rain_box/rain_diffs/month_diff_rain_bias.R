...
ggsave(filename = "01_biased_jan_diffs_rain.png",
       plot = jan, 
...
ggsave(filename = "02_biased_Feb_diffs_rain.png",
       plot = Feb, 
       width = 10, height = 6, units = "in",
       dpi=300, device = "png",
       path = plot_dir)
...
ggsave(filename = "03_biased_Mar_diffs_rain.png",
       plot = Mar, 
       width = 10, height = 6, units = "in",
       dpi=300, device = "png",
       path = plot_dir)
...
ggsave(filename = "04_biased_Apr_diffs_rain.png",
       plot = Apr, 
       width = 10, height = 6, units = "in",
       dpi=300, device = "png",
       path = plot_dir)
...
ggsave(filename = "05_biased_May_diffs_rain.png",
       plot = May, 
       width = 10, height = 6, units = "in",
       dpi=300, device = "png",
       path = plot_dir)
...
ggsave(filename = "06_biased_Jun_diffs_rain.png",
       plot = Jun, 
       width = 10, height = 6, units = "in",
       dpi=300, device = "png",
       path = plot_dir)
...
ggsave(filename = "07_biased_Jul_diffs_rain.png",
       plot = Jul, 
       width = 10, height = 6, units = "in",
       dpi=300, device = "png",
       path = plot_dir)
...
ggsave(filename = "08_biased_Aug_diffs_rain.png",
       plot = Aug, 
       width = 10, height = 6, units = "in",
       dpi=300, device = "png",
       path = plot_dir)
...
ggsave(filename = "09_biased_Sep_diffs_rain.png",
       plot = Sep, 
       width = 10, height = 6, units = "in",
       dpi=300, device = "png",
       path = plot_dir)
...
ggsave(filename = "10_biased_Oct_diffs_rain.png",
       plot = Oct, 
       width = 10, height = 6, units = "in",
       dpi=300, device = "png",
       path = plot_dir)
...
ggsave(filename = "11_biased_Nov_diffs_rain.png",
       plot = Nov, 
       width = 10, height = 6, units = "in",
       dpi=300, device = "png",
       path = plot_dir)
...
ggsave(filename = "12_biased_Dec_diffs_rain.png",
       plot = Dec, 
       width = 10, height = 6, units = "in",
       dpi=300, device = "png",
       path = plot_dir)
