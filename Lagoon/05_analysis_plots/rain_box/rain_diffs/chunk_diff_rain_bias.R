...
fileN <- "detail_med_diff_med_chunk_rain"
dt_tb <- data.table(readRDS(paste0(in_dir, fileN, ".rds")))
head(dt_tb, 2)

box_title <- "diff. of medians and median of obs."
...
ggsave(filename = "biased_mag_diff_chunk_rain.png", 
       plot = b, 
...
b <- ann_wtrYr_chunk_cum_box_cluster_x(dt=dt_tb,
                                       ...
                                       subttl= box_subtitle)
b <- b + ggtitle(box_title, subtitle=box_subtitle)
ggsave(filename = "biased_perc_diff_chunk_rain.png", 
       plot = b, 
       width = 9.5, height = 5, units = "in", 
       dpi=300, device = "png",
       path = plot_dir)
...
b <- ann_wtrYr_chunk_cum_box_cluster_x(dt=dt_tb_45,
                                       ...
                                       subttl=box_subtitle)
b <- b + ggtitle(box_title, subtitle=box_subtitle)
ggsave(filename = "biased_mag_diff_chunk_rain_45.png", 
       plot = b, 
...
ggsave(filename = "biased_perc_diff_chunk_rain_45.png", 
       plot = b, 
       width = 5, height = 2.5, units = "in", 
       dpi=400, device = "png",
       path = plot_dir)
...
b <- ann_wtrYr_chunk_cum_box_cluster_x(dt=dt_tb_85,
                                       ...
                                       subttl=box_subtitle)
b <- b + ggtitle(box_title, subtitle=box_subtitle)
ggsave(filename = "biased_mag_diff_chunk_rain_85.png", 
       plot = b, 
       width = 5, height = 2.5, units = "in", 
       dpi=400, device = "png",
       path = plot_dir)
...
ggsave(filename = "biased_perc_diff_chunk_rain_85.png", 
       plot = b, 
       width = 5, height = 2.5, units = "in", 
       dpi=400, device = "png",
       path = plot_dir)
