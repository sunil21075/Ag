...
out_dir <- "/data/hydro/users/Hossein/lagoon/03_rain_vs_snow/"
...
# saveRDS(rcp45_data, paste0(main_in, "rain_RCP45.rds"))
# saveRDS(rcp85_data, paste0(main_in, "rain_RCP85.rds"))
# saveRDS(hist_data, paste0(main_in, "rain_modeled_hist.rds"))
...
# saveRDS(all_modeled, paste0(main_in, "rain_all_modeled.rds"))
