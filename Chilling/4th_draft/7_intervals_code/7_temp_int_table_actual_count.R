...
for (month in months){
  setwd("/Users/hn/Desktop/Desktop/Kirti/check_point/chilling/7_temp_intervals_data/")
  iof = list(c(-Inf, -2), 
       c(-2, 4),
       c(4, 6),
       c(6, 8),
  ...
  # The data for 2076-2099 are from RCP 8.5
  df_help[, "location"] = c(paste0(month, "_rich_hist"), 
                            paste0(unlist(strsplit(month, "[.]"))[1], "_rich_76_99"), 
                            paste0(unlist(strsplit(month, "[.]"))[1], "_rich_diff"), 
                            paste0(unlist(strsplit(month, "[.]"))[1], "_omak_hist"), 
                            paste0(unlist(strsplit(month, "[.]"))[1], "_omak_76_99"), 
  ...
  if (month=="Oct.rds"){
    df_help[4, 2:6] <- v$no_hours
    } else if (month == "Jan.rds"){
    df_help[4, 2:6] <- v$no_hours
    } else {
    df_help[4, 2:8] <- v$no_hours
  }
  ...
  write.table(x = perc_table, row.names=F, col.names = T, sep=",",
        file = paste0("perc_table_", unlist(strsplit(month, "[.]"))[1], ".csv"))  
}
