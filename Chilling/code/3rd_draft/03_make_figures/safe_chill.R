...
produce_data_4_plots <- function(data){
    ...
    # time periods are 
    time_periods = c("2025_2050", "2051_2075", "2076_2099")
    data$time_period = 0L
    data$time_period[data$year<= 2051] = time_periods[1]
    data$time_period[data$year > 2051 & data$year <= 2076] = time_periods[2]
    data$time_period[data$year > 2076] = time_periods[3]
...
safe_box_plot <- function(data){
    color_ord = c("dodgerblue", "olivedrab4", "red") # "grey70" 
    box_width = 0.25
    categ_lab = c("2025-2050", "2051-2075", "2076-2099")
    ...
    safe_b <- ggplot(data = data, aes(x=time_period, y=quan_90, fill=time_period)) +
              ...
              scale_color_manual(values = color_ord,
                                 ...
                                 limits = color_ord,
                                 labels = categ_lab) + 
              scale_x_discrete(breaks = c("2025_2050", "2051_2075", "2076_2099"),
                               labels = categ_lab)  +
...
ensemble_map <- function(data, color_col) {
