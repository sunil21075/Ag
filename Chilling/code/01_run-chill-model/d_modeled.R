...
local_files <- read.delim(file = "/home/hnoorazar/chilling_codes/parameters/file_list.txt",
                          header = F)
local_files <- as.vector(local_files$V1)
local_files = local_files[1:10]
...
main_out <- file.path("/data/hydro/users/Hossein/chill/data_by_running_matt_code/")
