...
threshold_func <- function(file, data_type){
  ...
  data <- data %>% 
          ...
          summarise(sum = sum(Daily_portions),
                    thresh_50 = unique(thresh_20), # retain the thresholds
                    thresh_75 = unique(thresh_25),
                    thresh_75 = unique(thresh_30),
                    thresh_75 = unique(thresh_35),
                    thresh_75 = unique(thresh_40),
                    thresh_75 = unique(thresh_45),
                    thresh_75 = unique(thresh_50),
                    thresh_75 = unique(thresh_55),
                    thresh_75 = unique(thresh_60),
                    thresh_75 = unique(thresh_65),
                    thresh_75 = unique(thresh_70),
