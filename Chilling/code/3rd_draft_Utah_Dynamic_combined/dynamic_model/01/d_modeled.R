...
##############################
#
# model_type should be either
# "dynamic" or "utah".
# You MUST also use proper 
# qsub file for it.
#
#
##############################
...
########################################################
#
# Define needed paths, like output and parameter path 
#
########################################################

# main output path
if (model_type == "dynamic"){
  main_out <- file.path("/data/hydro/users/Hossein/chill/data_by_core/11_threshold/01/modeled")
} else{
  main_out <- file.path("/data/hydro/users/Hossein/chill/data_by_core/utah_model/01/observed/")
}
