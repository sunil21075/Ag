...
read_binary_4 <- function(file_name, file_path, hist){
	...
	data <- readbinarydata_addmdy_4var(file_path, ymd_file)
	return(data)
}
...
read_binary_8 <- function(file_name, file_path, hist){
	...
	ymd_file <- create_ymdvalues(start_year, end_year)
	data <- readbinarydata_addmdy_8var(file_path, ymd_file)
	return(data)
}
...
readbinarydata_addmdy_8var <- function(filename, ymd){
...
readbinarydata_addmdy_4var <- function(filename, ymd) {
