...
for (model in models){
  ...
  curr_hist <- data.table(readRDS(paste0(main_in, model, "/historical_data_till_Feb.rds")))
  curr_45 <- data.table(readRDS(paste0(main_in, model, "/rcp45_data_till_Feb.rds")))
  curr_85 <- data.table(readRDS(paste0(main_in, model, "/rcp85_data_till_Feb.rds")))
...
saveRDS(rcp45, paste0(out_dir, "/rcp45_till_Feb.rds"))
saveRDS(rcp85, paste0(out_dir, "/rcp85_till_Feb.rds"))
print ("line 85")
# ###################################################################
# #
...
first_frost <- data.table(readRDS(paste0(in_n_out, "first_frost_till_Feb.rds")))
...
#######################################
fifth_frost <- data.table(readRDS(paste0(in_n_out, "fifth_frost_till_Feb.rds")))
