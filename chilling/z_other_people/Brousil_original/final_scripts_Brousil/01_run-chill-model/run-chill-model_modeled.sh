...
#PBS -k o
  ##PBS -j oe
#PBS -e /fastscratch/mbrousil/chill-model_modeled.e
#PBS -o /fastscratch/mbrousil/chill-model_modeled.o
...
Rscript --vanilla ~/scripts/chill-model_modeled.R
