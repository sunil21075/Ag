...
for (due in dues){
  ...
  for (lim in seq(20, 75, 5)){
    ...
    frost_plot_dir <- paste0(frost_dir, "not_cloudy/w_obs/just_frost/")
    bloom_thresh_plot_dir <- paste0(frost_dir, "not_cloudy/w_obs/bloom_thresh_in_one/", col_name, "/")
    ...
    for (ct in cities){
      for (em in emissions){
        ...
        for (app_tp in apple_types){
          ...
          just_bloom_plot_dir <- paste0(frost_dir, "not_cloudy/w_obs/just_bloom/")
          ...
          just_thresh_plot_dir <- paste0(frost_dir, "not_cloudy/w_obs/just_thresh/thresh_", lim, "/")
