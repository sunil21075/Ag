...
for (due in dues){
  ...
  for (lim in seq(20, 75, 5)){
    ...
    frost_plot_dir <- paste0(frost_dir, "cloudy/no_obs/just_frost/")
    bloom_thresh_plot_dir <- paste0(frost_dir, "cloudy/no_obs/bloom_frost_in_one/", col_name, "/")
    ...
    for (ct in cities){
      for (em in emissions){
        ...
        just_thresh_plot_dir <- paste0(frost_dir, "cloudy/no_obs/just_thresh/thresh_", lim, "/")
