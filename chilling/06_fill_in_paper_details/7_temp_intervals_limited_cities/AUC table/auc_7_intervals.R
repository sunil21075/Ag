...
data_dir = "/Users/hn/Documents/01_research_data/chilling/7_temp_int_limit_locs/untitled/RDS_files/"
...
modeled = data.table(readRDS(paste0(data_dir, "modeled.rds")))
observed = data.table(readRDS(paste0(data_dir, "observed.rds")))
