...
stagein()
{
  ...
  mkdir metdata
  # transfer soil file
  cp -r /data/hydro/users/kiran/Data/VIC/params/soil/soilparamsensitivities/thisjobname/newparams/soil_param.set1 ./
  
  # transfer crop parameter and lib files
  cp -r /data/hydro/users/kiran/Data/VIC/params/crop/cropparam_Sep27_2011_noprecip_WSDA_alloutside_pasture50p ./
  cp -r /data/hydro/users/kiran/Data/VIC/params/crop/croplib_allcrops ./

  # transfer veg param and lib file
  cp -r /data/hydro/users/kiran/Data/VIC/params/veg/vegparam_allcrops ./
  cp -r /data/hydro/users/kiran/Data/VIC/params/veg/veglib ./

  # transfer CropSyst folder
  cp -r /data/hydro/users/kiran/Data/VIC/params/CropSyst ./
    
  # transfer global paramter file
  cp -r /data/hydro/users/kiran/Data/VIC/params/global/kirtifirstpaper/hist/global_param_set1 ./
  
  # transfer the executable file
  cp -r /data/hydro/users/kiran/VIC/VIC_Crop/VICCROP407 ./

  # transfer the met data
  cat /data/hydro/users/kiran/Data/VIC/params/metdatalistmultipleset/list_set1 | while read LINE ; do
  echo "copying $LINE..."
  #cp /data-failing/part2/kirti/vic_inputdata0625_pnw_combined_05142008/$LINE ./metdata/
  cp /data/hydro/users/kiran/vic_inputdata0625_pnw_combined_05142008/$LINE ./metdata/
  done
  cd metdata
...
stageout()
{
  ...
  cp -r ./cropcells_set1/* /data/hydro/users/kiran/firstpaper/thisjobname/
