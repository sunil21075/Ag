#PBS -N soil_param_b-inf_1.1_set1
...
stagein()
{
	 ...
	 pwd
	 cd ${WORKDIR}
	 rm -r soil_param_b-inf_1.1_set1
	 mkdir soil_param_b-inf_1.1_set1
	 cd soil_param_b-inf_1.1_set1
	 ...
	 mkdir metdata
	 # transfer soil file
	 cp -r  /data/kiran/Data/VIC/params/soil/soilparamsensitivities/soil_param_b-inf_1.1/newparams/soil_param.set1 ./
...
stageout()
{
	 ...
	 cp -r ./cropcells_set1/* /data/kiran/firstpaper/soil_param_b-inf_1.1/
