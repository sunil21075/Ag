...
# original
diapause <- function(x){
  ifelse(102.6077 * exp(-exp(1.306483 * (x - 16.95815))) > 100, 100, 102.6077 * exp(-exp(1.306483 * (x - 16.95815))))
}
# red solid one
diapause_2 <- function(x){
  ifelse(103 * exp(-exp(.8 * (x - 15.95)))>100, 100, 103 * exp(-exp(.8 * (x - 15.95))))
}

# blue solid
diapause_3 <- function(x){
  ifelse(103 * exp(-exp(.95 * (x - 16.5 ))) > 100, 100, 103 * exp(-exp(.95 * (x - 16.5 ))))
}
# bright green solid
diapause_4 <- function(x){
  ifelse(104 * exp(-exp(.8 * (x - 16.3 ))) > 100, 100, 104 * exp(-exp(.8 * (x - 16.3 ))))
}
# dot line
diapause_5 <- function(x){
  ifelse(104 * exp(-exp(.7 * (x - 15.6 ))) > 100, 100, 104 * exp(-exp(.7 * (x - 15.6 ))))
}

diapause_6 <- function(x){
  ifelse(104 * exp(-exp(.6 * (x - 15.3 ))) > 100, 100, 104 * exp(-exp(.6 * (x - 15.3 ))))
}

# orange
diapause_7 <- function(x){
  ifelse(103 * exp(-exp(1.1 * (x - 16.8 ))) > 100, 100, 103 * exp(-exp(1.1 * (x - 16.8 ))))
}
