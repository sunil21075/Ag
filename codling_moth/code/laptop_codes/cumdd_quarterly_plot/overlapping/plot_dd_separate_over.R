...
for (vers in version){
  ...
  bplot <- ggplot(data = data, aes(x=season, y=value), group = season) + 
           ...
           theme(legend.position="bottom", 
                 ...
                 axis.text.x = element_text(size=12, face="bold", color="black"), # tick text font size
...
ggsave("cumdd_qrt_sep.png", cumdd_plot_qrt, width=15, height=4, unit="in", path="./", dpi=400, device="png")
# ggsave("cumdd_qrt_sep_350.png", A, width=15, height=4, unit="in", path="./", dpi=350, device="png")
