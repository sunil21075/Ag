...
egg_pweibul = ggplot(data.frame(x=x_limits), aes(x=x)) + the_theme + 
			  geom_path(stat="function", fun=dw_egg_1, aes(colour="grey70"), linetype=1)+
			  geom_path(stat="function", fun=dw_egg_2, aes(colour="dodgerblue"), linetype=1)+
			  geom_path(stat="function", fun=dw_egg_3, aes(colour="olivedrab4"), linetype=1)+
			  geom_path(stat="function", fun=dw_egg_4, aes(colour="red"), linetype=1)+
			  geom_path(stat="function", fun=dw_egg_1_shift, aes(colour="grey70"), linetype=2)+
			  geom_path(stat="function", fun=dw_egg_2_shift, aes(colour="dodgerblue"), linetype=2)+
			  geom_path(stat="function", fun=dw_egg_3_shift, aes(colour="olivedrab4"), linetype=2)+
			  geom_path(stat="function", fun=dw_egg_4_shift, aes(colour="red"), linetype=2)+
