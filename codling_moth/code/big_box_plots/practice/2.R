...
#combined_CM45 <- readRDS("/Users/hn/Desktop/Kirti/check_point/my_aelous_2006/combined_CM_rcp45.rds")
data <- combined_CM45
...
bplot <- ggplot(data = data_melted, aes(x=variable, y=value)) + 
  ...
  facet_wrap(CountyGroup ~ variable, scales="free", ncol=6, dir="v") + 
  ...
  scale_color_manual(values=color_ord,
                     ...
                     labels=c("Historical","2040","2060","2080")) +
  coord_flip() 
output_name = "45_2_2006.png"
plot_path <- "/Users/hn/Desktop/Kirti/big_box_plots/2/"
...
#combined_CM85 <- readRDS("/Users/hn/Desktop/Kirti/check_point/my_aelous_2006/combined_CM_rcp85.rds")
data <- combined_CM85
data <- subset(data, select = c("AGen1_0.25", "AGen1_0.5", "AGen1_0.75", 
                                "AGen2_0.25", "AGen2_0.5", "AGen2_0.75",
                                "AGen3_0.25", "AGen3_0.5", "AGen3_0.75", 
