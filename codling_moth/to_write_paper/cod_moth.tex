...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{./rcp45_50}
  \label{fig:DDC45}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{figures/cumdd_plots/cumdd_qrt_rcp45copy}
  \label{fig:DDC45}
\caption{Degree Day Changes (rcp 4.5)}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{figures/cumdd_plots/cumdd_qrt_rcp85copy}
  \label{fig:DDC85}
\caption{Degree Day Changes (rcp 8.5)}
\end{subfigure}
%%%%%%%
