...
\title{Help \& Documentation\footnote{Name of the programmer of functions is written in the code for debugging purposes. If you see any flaw, please contact the programmer.}}
\author{}
\date{}
\maketitle
\vspace{-.71in}
...
\input{dynamic_model}
\input{Codling_Moth_Generations}
