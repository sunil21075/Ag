...
plot_path <- "/Users/hn/Documents/GitHub/Kirti/Codling_moth_Code/big_box_plots/3_evolve/half_R/"
...
for (stage in stages){
  for (version in versions){
    ...
    plot_flight_half(input_dir=input_dir, input_name=input_name, stage=stage, output_dir=plot_path, output_name=output_name)
  }
}
