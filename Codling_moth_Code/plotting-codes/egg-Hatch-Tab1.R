...
## associated with Egg Hatch into Larva tab on the left, "Cumulative Larva Pop. Fraction".
## this just produces the warmer part. I donnot how to create and add the cooler part to it, yet!
##
#############################################################################################
model = "rcp45"
