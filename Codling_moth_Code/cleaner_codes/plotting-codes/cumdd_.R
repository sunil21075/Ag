...
version = 'rcp45'
compute_cumdd <- function(input_dir = data_dir, file_name="combined_CMPOP_", version)
#
...
#    strip.text = element_text(size = 18, face = "bold"))
#
##ggsave("cumdd_plot2.png", plot1, width = 45, height = 22, units = "cm")
...
#ggsave("cumdd_plot3_rcp45.png", plot2, width = 37, height = 50, units = "cm")
