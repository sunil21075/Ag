...
write_path = "/data/hydro/users/Hossein/codling_moth/speed_test/"
data_dir = "/data/hydro/users/Hossein/codling_moth/raw_data/local_data/"
...
conn = file(paste0(parameters_path, file_list), open = "r")
