...
###########
  ...
  output$full_bloom <- renderImage({
    ...
    filename <- normalizePath(file.path('./plots', 'bloom2.png'))
  ...
  output$cumdd <- renderImage({
    filename <- normalizePath(file.path('./plots', 'cumdd_plot2.png'))
  ...
  output$cum_larva_pop <- renderImage({
    filename <- normalizePath(file.path('./plots', 'cumdd_plot.png'))
  ...
  output$cumdd_rcp45 <- renderImage({
    filename <- normalizePath(file.path('./plots', 'cumdd_plot2_rcp45.png'))
  ...
  output$cum_larva_pop_rcp45 <- renderImage({
    filename <- normalizePath(file.path('./plots', 'cumdd_plot_rcp45.png'))
