...
main_in <- paste0(bloom_base, "02_bloomCut_first_frost/frost/")
...
# saveRDS(rcp45, paste0(out_dir, "/first_frost_rcp45.rds"))
# saveRDS(rcp85, paste0(out_dir, "/first_frost_rcp85.rds"))

all_frost <- rbind(rcp45, rcp85)
saveRDS(all_frost, paste0(out_dir, "/first_frost.rds"))
